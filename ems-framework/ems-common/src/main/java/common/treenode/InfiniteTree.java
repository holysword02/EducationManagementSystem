...
public class InfiniteTree<M extends BaseMapper<X>, X> {
            ...
            for (X x : list) {
                ...
                try {
                    treeNodeList.add(new TreeNode(
                            ...
                            x.getClass().getMethod("get" + toU(labelName)).invoke(x).toString(),
                            node));
    ...
    public List<TreeNode> getTreeNodeList(List<X> list,
        ...
        return createTree(treeNodeList, list, 0, column, methodName, valueName, labelName);
    }
     ...
     */
    public List<TreeNode> getTreeNodeList(List<X> list, int n,
                                          String column, String methodName,
                                          String treeValueName, String treeLabelName) {
        List<TreeNode> treeNodeList = new ArrayList<>();
        return createTree(treeNodeList, list, n, column, methodName, treeValueName, treeLabelName);
    }
